# 🧪 BookSphere — Test Cases (50 Total)
...
| --- | --- | --- | --- |
| 1 | 🔐 Login | 14 | TC_L_01 – TC_L_14 |
| 2 | 📚 Catalog | 12 | TC_C_01 – TC_C_12 |
| 3 | 🛒 Cart | 12 | TC_CA_01 – TC_CA_12 |
| 4 | 📦 Orders | 7 | TC_O_01 – TC_O_07 |
| 5 | 🔌 API | 5 | TC_A_01 – TC_A_05 |
| | **Total** | **50** | |
...
## 🔐 Login Tests (14 cases)

| TC ID | Test Case Title | Preconditions | Test Steps | Test Data | Expected Result | Actual Result | Status | Priority | Type |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
